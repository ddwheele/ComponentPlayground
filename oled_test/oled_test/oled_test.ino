...
void drawBlinkStep(int left, int up, int percentClosed, int hold) {
  ...
  display.fillRect(0, 0,
                   display.width(), (eyeCenterY + lidCenterY) / 2,
                   SSD1306_BLACK);
  display.display();
  delay(hold);
}
...
*/
void drawLaughEyes(int left, int up, int leftEyeCenterX, int rightEyeCenterX, int eyeCenterY) {
  ...
  // "erase" bottom parts
  display.fillRect(leftEyeCenterX - EYE_RADIUS, (eyeCenterY + cheekCenterY) / 2,
                   2 * EYE_RADIUS + 2, 2 * EYE_RADIUS,
                   SSD1306_BLACK);

  display.fillRect(rightEyeCenterX - EYE_RADIUS, (eyeCenterY + cheekCenterY) / 2,
                   2 * EYE_RADIUS + 2, 2 * EYE_RADIUS,
                   SSD1306_BLACK);
}
